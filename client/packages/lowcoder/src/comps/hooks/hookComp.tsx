...
type SelectHookViewProps = {
  children: React.ReactNode;
  compName: string;
};

function SelectHookView(props: SelectHookViewProps) {
  const setSelectedCompNames = useEditorStore((state) => state.setSelectedCompNames);
  const handleClick = useCallback(() => {
    setSelectedCompNames(new Set([props.compName]));
  }, [props.compName, setSelectedCompNames]);
