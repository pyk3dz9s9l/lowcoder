...
export const en = {
  ...
  "style": {
    ...
    "chatInputText": "Text",
    "chatInputBorder": "Border",
    "chatInputRadius": "Radius",
    "chatInputPadding": "Padding",
    "chatInputAreaBackground": "Area BG",
    "chatInputAreaBorder": "Area Border",
    "chatSendButtonBackground": "Send Btn BG",
    "chatSendButtonIcon": "Send Btn Icon",
  ...
  "chatBox": {
    "messageSent": "Message Sent",
    "messageSentDesc": "Triggered when the user presses send. Read chatBox.lastSentMessageText to get the message content.",
    ...
    "aiRoomMessage": "— every user message triggers your Lowcoder query. The AI response is broadcast to all members in real time.",
